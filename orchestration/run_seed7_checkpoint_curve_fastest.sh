...
# fastest 8-GPU preset.  Completed seed-7 runs from the preceding 3x3 grid are
...
OUT_ROOT=${OUT_ROOT:-$ROOT/eval_out/h100_b64_fastio_seed42_seed7_curve_fastest}
REUSE_ROOT=${REUSE_ROOT:-$ROOT/eval_out/h100_b64_fastio_seed42_3ckpt_3seed_fastest}
